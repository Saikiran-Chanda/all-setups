...
sed -i '50  a\</tomcat-users>' apache-tomcat-9.0.106/conf/tomcat-users.xml
sed -i '3yy' apache-tomcat-9.0.106/conf/tomcat-users.xml
sed -i '21d' apache-tomcat-9.0.106/webapps/manager/META-INF/context.xml
sed -i '2dd'  apache-tomcat-9.0.106/webapps/manager/META-INF/context.xml
